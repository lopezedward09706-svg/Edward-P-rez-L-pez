        ...
        <div className="bg-glass backdrop-blur-md border border-white/10 rounded-xl p-4 flex flex-col h-full overflow-hidden">
             <div className="flex flex-wrap gap-1 mb-4">
                <button 
                    ...
                    className={`flex-1 px-2 py-1.5 text-xs font-bold rounded border ${activeTab === 'chat' ? 'bg-blue-500/30 border-blue-400' : 'bg-black/30 border-white/10 hover:bg-white/10'}`}
                >
                    💬 CHAT
                </button>
                {IATabs.map(ia => (
                    <button 
                        ...
                        className={`flex-1 px-2 py-1.5 text-xs font-bold rounded border ${activeTab === ia.id ? `bg-white/10 border-white` : 'bg-black/30 border-white/10 hover:bg-white/10'}`}
